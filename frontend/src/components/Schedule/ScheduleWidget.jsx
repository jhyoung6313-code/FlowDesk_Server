    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '7px 14px', borderBottom: `1px solid ${border}` }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginLeft: 4 }}>
          <span style={navBtn} onClick={() => setWeekStart((w) => w.subtract(1, 'week'))}><LeftOutlined style={{ fontSize: 12 }} /></span>
          <span style={{ fontSize: 12, fontWeight: 700, color: text1, padding: '0 2px' }}>
            {weekStart.format('MM.DD')} ~ {weekStart.add(6, 'day').format('MM.DD')}
          </span>
          <span style={navBtn} onClick={() => setWeekStart((w) => w.add(1, 'week'))}><RightOutlined style={{ fontSize: 12 }} /></span>
        ...
        {days.map((d, i) => {
          ...
          return (
            <div key={`h${i}`} style={{
              ...
              <span style={{
                fontSize: 12, fontWeight: 700, color: holiday ? '#DC2626' : text1,
              ...
              <span style={{ fontSize: 12, fontWeight: 700, color: dowColor }}>({dow[d.day()]})</span>
            </div>
          );
        })}
            ...
            >
              {holiday && (
                <span title={holiday} style={{
                  fontSize: 12, fontWeight: 700, color: '#DC2626', lineHeight: 1.25,
              ...
              {dayEvents.length > 3 && (
                <span style={{ fontSize: 12, color: text2, fontWeight: 600, paddingLeft: 3 }}
