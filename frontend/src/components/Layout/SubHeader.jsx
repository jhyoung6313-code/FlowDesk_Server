...
export default function SubHeader() {
  ...
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontSize: 12, color: TEXT2, fontWeight: 500, marginBottom: 2 }}>
          {greet()} · {dateStr}
        </div>
      ...
      <div style={{
        ...
        {stats.map(({ v, l, c }, i, arr) => (
          ...
          >
            ...
            <span style={{ fontSize: 12, fontWeight: 500, color: TEXT2, textTransform: 'uppercase', letterSpacing: '.5px' }}>{l}</span>
          </div>
        ))}
      </div>
    </div>
