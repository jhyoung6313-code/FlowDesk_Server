                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      maxWidth: 310,
                      flex: '0 0 285px',
                      background: dragOver === col.key ? '#e6f4ff' : overWip ? '#fff2f0' : 'var(--fd-sk-surface-sunken, #f7f8fa)',
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 'var(--fd-sk-radius, 10px)',
        border: `var(--fd-sk-border-w, 1px) solid ${hover ? 'var(--fd-sk-border-color, #d0d0d0)' : 'var(--fd-border)'}`,
        boxShadow: hover ? 'var(--fd-sk-shadow-hover, 0 4px 14px rgba(0,0,0,0.1))' : 'var(--fd-sk-shadow-sm, 0 1px 3px rgba(0,0,0,0.05))',
        overflow: 'hidden',
